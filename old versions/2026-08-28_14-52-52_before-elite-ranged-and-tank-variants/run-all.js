...
const SUITES = [
  ...
  ['elitevariantunit',41, 'шесть ближних разновидностей элиты: спрайты, выбор, защита и контактные эффекты'],
  ...
  ['bosshudunit',   31, 'компактный Canvas Boss HUD: один/два босса, delayed HP, rare и маркеры'],
