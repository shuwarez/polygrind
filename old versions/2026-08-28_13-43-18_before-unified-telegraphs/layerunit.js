...
c.render();
const expected=['ground','telegraphs','floorEffects','itemsProjectiles','entities','impactEffects','worldHud','combatText','domHud'];
...
ok('предупреждения боссов изолированы в telegraphs',/if \(pass==='telegraphs'\)\{\s*\/\/ Бегемот/.test(html));
