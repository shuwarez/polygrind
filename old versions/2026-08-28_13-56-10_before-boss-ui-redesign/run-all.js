...
const SUITES = [
  ...
  ['damagefeedbackunit',24, 'урон, лечение и барьер игрока: feedback, два HP-бара и combat text'],
  ['layerunit',     12, 'фиксированные Canvas-слои: телеграфы, персонажи, HUD, combat text и виньетка'],
