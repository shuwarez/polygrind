...
const SUITES = [
  ...
  ['spawnmenuunit',30, 'Spawn Menu: K, все враги/элита/боссы, близкая позиция и progression'],
  ...
  ['spriteunit',    14, 'PNG-враги и снаряд Призмы: кадры, разворот, масштаб и палитра'],
  ['bossunit',      37, 'восемь уникальных боссов: листы, умения, редкость и награды'],
