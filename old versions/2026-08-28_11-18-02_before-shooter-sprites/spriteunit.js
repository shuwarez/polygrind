...
ok('три листа встроены как индексированные PNG 40/48 px на кадр',
...
ok('Бастион получил 4 кадра, геометрической осталась Призма',
  [0,1,2,3].every(i => c.enemySpriteFrame({typeKey:'tank',animT:i}).frame.w===48) && c.enemySpriteFrame({typeKey:'shooter',animT:0})===null);
