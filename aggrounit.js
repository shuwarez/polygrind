...
function fresh(random=()=>0.5){const c=loadGame('./index.html',{random});c.newGame('necro','keys');const G=c.__api.G;G.enemies=[];G.minions=[];G.spawnQueue=0;G.packs=[];G.weapon.noAttack=true;G.player.x=G.player.y=0;G.player.inv=999;return{c,G,D:c.__api.D,p:G.player};}
