...
function mk(mods, amus, options){
  const c = loadGame('./index.html', options);
...
{ const c=loadGame('./index.html'),m=c.__api.MODS.find(x=>x.id==='min.count');
...
{ const c=loadGame('./index.html'); c.newGame('necro','keys'); const G=c.__api.G;
...
{ const c=loadGame('./index.html'); c.newGame('necro','keys'); c.setLanguage('ru');
...
{ const c=loadGame('./index.html'); c.newGame('necro','keys'); const G=c.__api.G,m=c.__api.MODS.find(x=>x.id==='min.count'),limits=[];
...
{ const c=loadGame('./index.html'); c.newGame('necro','keys'); c.setLanguage('ru'); c.renderSheet();
...
{ const c=loadGame('./index.html'); c.newGame('necro','keys'); const G=c.__api.G;
  ...
  const fresh=loadGame('./index.html'); fresh.newGame('necro','keys');
...
{ const c=loadGame('./index.html'); c.newGame('necro','keys'); const G=c.__api.G,m=c.__api.MODS.find(x=>x.id==='min.bone_field');
...
{ const c = loadGame('./index.html'); c.newGame('necro','keys','venomancer');
