...
function fresh(random){const c=loadGame('./index.html',random?{random}:{});c.newGame('necro','keys');const G=c.__api.G;G.enemies=[];G.minions=[];G.spawnQueue=0;G.packs=[];return{c,G,D:c.__api.D,p:G.player};}
