...
function fresh(random=()=>0.5){const c=loadGame('./PolyGrind.html',{random});c.newGame('bow','keys');const G=c.__api.G;G.enemies=[];G.spawnQueue=0;return{c,G,p:G.player,D:c.__api.D};}
