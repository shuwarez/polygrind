...
function fresh(){const c=loadGame('./PolyGrind.html');c.newGame('blade','keys');const G=c.__api.G;G.enemies=[];G.spawnQueue=0;G.packs=[];return{c,G,D:c.__api.D,p:G.player};}
