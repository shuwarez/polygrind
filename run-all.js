...
const SUITES = [
  ...
  ['bloodunit',     18, 'кровь этажа: фактический HP, атласы, декали, DoT, лимиты и слои'],
  ...
  ['herospriteunit',78, 'герои и подклассы, звук, анимированное меню Grim Grind, витрина выбора класса и уникальные рамки'],
