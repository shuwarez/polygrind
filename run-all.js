...
const SUITES = [
  ...
  ['corpseunit',    31, 'трупы всех монстров и классов: 30 исходных спрайтов, 50% луж, шесть вариантов, слои и culling'],
  ...
  ['spriteunit',    56, 'PNG-враги, лужи, портал, звуки, элементальные состояния, добыча, предметы, тотемы, свита, снаряды и эффекты Мага'],
  ...
  ['herospriteunit',81, 'герои и 8-кадровые подклассы, звук, классическое меню и классовые рамки'],
