...
const SUITES = [
  ...
  ['reliableunit',66, 'баланс карточек: урон, таймер недавнего убийства, критическая волна, защита, оглушение и добивание'],
  ...
  ['spriteunit',    37, 'PNG-враги, портал, элементальные состояния, добыча, редкие предметы, тотемы, свита, снаряды и эффекты Мага'],
