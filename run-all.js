...
const SUITES = [
  ...
  ['qolunit',     36, 'раскладки, выбор карт цифрами и переброс пробелом, ВОР, рывок, сбор, удалённые карточки, журнал смерти и боссы'],
  ['generalskillunit',19,'Передышка, Критическая масса, Запас прочности и Эхо атаки'],
  ['floortransitionunit',29, 'завершение этажа: автосбор, очередь level-up/находок, подсказки и телепорт'],
