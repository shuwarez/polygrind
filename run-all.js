...
const SUITES = [
  ...
  ['floortransitionunit',30, 'завершение этажа: автосбор, пробел в сводке, очередь level-up/находок и телепорт'],
  ...
  ['spriteunit',    26, 'PNG-враги, свита, снаряды и эффекты Мага: кадры, маршруты, масштаб и палитра'],
  ...
  ['warriorunit',  49, 'подклассы, классовый пул и новые ветки Воина'],
  ['archerunit',   36, 'ветки Лучника: дальность, траектория, разделение, возврат и метки'],
