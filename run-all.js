...
const SUITES = [
  ...
  ['warriorunit',  68, 'подклассы, классовый пул и новые ветки Воина'],
  ['archerunit',   60, 'подклассы и ветки Лучника: траектория, возврат, Зеркальный залп и Техника одной стрелы'],
  ['mageunit',      57, 'три подкласса и семь новых веток Мага, включая Мину и Повторную детонацию'],
];
