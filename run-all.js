...
const SUITES = [
  ...
  ['scaleunit',    4, 'фиксированный урон героев, рост урона, здоровье боссов и скорость врагов'],
  ...
  ['cameraunit',   20, 'камера: DPR-лимит, фиксированный центр, zoom 0.95, мышь, culling и экранные слои'],
  ['cullingunit', 24, 'консервативное отсечение рендера: края, ауры, боссы, снаряды, эффекты и телеграфы'],
  ['bloodunit',     27, 'кровь этажа: фактический HP, пулы, атласы, декали, DoT, burst-лимит и слои'],
  ...
  ['mageunit',      60, 'три подкласса, общая корзина радиуса, лимиты крови и стихийного FX Мага'],
];
