...
{ const fast=loadGame('./PolyGrind.html'); fast.__api.STORE.data.shop.regen=10;
...
{ const legacySpeed=loadGame('./PolyGrind.html'), old={base:1000,grow:1.11};
...
{ const fast=loadGame('./PolyGrind.html'); fast.__api.STORE.data.shop={dashRecharge:10,dashLength:5};
  ...
  const normal=loadGame('./PolyGrind.html');normal.newGame('bow','keys');
