...
{ const c=loadGame('./index.html'); c.newGame('bow','keys'); const G=c.__api.G; G.floor=5; G.enemies.length=0;
...
{ const c=loadGame('./index.html'); c.newGame('bow','keys'); const G=c.__api.G; G.floor=20;G.enemies.length=0;
...
{ const c=loadGame('./index.html'); c.newGame('bow','keys'); const G=c.__api.G;G.floor=20;G.enemies.length=0;G.packs.length=0;
