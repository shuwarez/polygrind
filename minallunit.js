...
{ const o = mk([['knock',100]]);
  const kx = o.e.kb.x, ky = o.e.kb.y; hit(o);
  ok('отбрасывание', o.e.kb.x !== kx || o.e.kb.y !== ky); }
...
{ const o = mk([], ['bone']);
  o.p.hitN = 19; const h0 = o.e.hp; hit(o);
  const crit = h0 - o.e.hp;
  o.p.hitN = 5; const h1 = o.e.hp; hit(o);
  ok('кость удачи: 20-й удар свиты — крит', crit > (h1 - o.e.hp),
     Math.round(h1-o.e.hp) + ' \u2192 ' + Math.round(crit)); }
