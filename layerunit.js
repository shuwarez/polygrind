...
c.render();
const expected=['ground','bloodGround','telegraphs','floorEffects','itemsProjectiles','entities','bloodFx','impactEffects','worldHud','combatText','bossHud','domHud'];
...
ok('постоянная кровь лежит над полом и под телеграфами',calls.indexOf('ground')<calls.indexOf('bloodGround') && calls.indexOf('bloodGround')<calls.indexOf('telegraphs'));
