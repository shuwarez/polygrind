...
c.render();
const expected=['ground','bloodGround','corpses','telegraphs','floorEffects','itemsProjectiles','entities','bloodFx','impactEffects','worldHud','combatText','bossHud','domHud'];
...
ok('кровь и трупы лежат над полом и под телеграфами',calls.indexOf('ground')<calls.indexOf('bloodGround') && calls.indexOf('bloodGround')<calls.indexOf('corpses') && calls.indexOf('corpses')<calls.indexOf('telegraphs'));
...
ok('брызги лежат над существами и под impact effects',calls.indexOf('entities')<calls.indexOf('bloodFx') && calls.indexOf('bloodFx')<calls.indexOf('impactEffects'));
